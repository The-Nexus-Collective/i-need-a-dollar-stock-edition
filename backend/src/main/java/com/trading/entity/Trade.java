...
/**
 * Paper trade entity - completed trades with entry and exit
...
public class Trade {
    ...
    @Column(name = "pnl_usdt", nullable = false, precision = 20, scale = 2)
    ...
    public boolean isWinning() {
        return pnlUsdt != null && pnlUsdt.compareTo(BigDecimal.ZERO) > 0;
    }
}
