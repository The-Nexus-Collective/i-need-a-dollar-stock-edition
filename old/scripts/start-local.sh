...
setup_environment() {
    ...
    # Override for local development (asyncpg needs plain postgresql://, not +asyncpg)
    export DATABASE_URL="postgresql://trading_user:${DB_PASSWORD:-trading_secret_2024}@localhost:5432/trading_platform"
